            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Extra Pages";$title = "Search Results";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="search-item">
                                                            ...
                                                            <div class="font-13 text-success mb-2 text-truncate">
                                                                http://Spiderhunts.com/zircos/index.php
                                                            </div>
                                                        ...
                                                        <div class="search-item">
                                                            ...
                                                            <div class="font-13 text-success mb-2 text-truncate">
                                                                http://themeforest.net/user/Spiderhunts/portfolio?ref=Spiderhunts
                                                            </div>
                                                            <p class="mb-0 text-muted">
                                                                Dolor posuere proin blandit accumsan senectus netus nullam curae, ornare laoreet adipiscing luctus mauris adipiscing pretium eget fermentum, tristique lobortis est ut metus lobortis tortor tincidunt himenaeos habitant quis dictumst proin odio sagittis purus mi, nec taciti vestibulum quis in sit varius lorem sit metus mi.
                                                            </p>
                                            ...
                                            <div class="tab-pane" id="users">
                                                ...
                                                <div class="search-item">
                                                    <div class="d-flex align-items-start">
                                                        <img class="d-flex me-3 rounded-circle" src="assets/images/users/user-3.jpg" alt="Generic placeholder image" height="54">
                                                        <div class="w-100">
                                                            <h5 class="mt-0">
                                                ...
                                                <div class="search-item">
                                                    <div class="d-flex align-items-start">
                                                        <img class="d-flex me-3 rounded-circle" src="assets/images/users/user-4.jpg" alt="Generic placeholder image" height="54">
                                                        <div class="w-100">
                                                            <h5 class="mt-0">
                                                ...
                                                <div class="search-item">
                                                    <div class="d-flex align-items-start">
                                                        <img class="d-flex me-3 rounded-circle" src="assets/images/users/user-5.jpg" alt="Generic placeholder image" height="54">
                                                        <div class="w-100">
                                                            <h5 class="mt-0">
