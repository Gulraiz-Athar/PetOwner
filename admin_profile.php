                ...
                <div class="card text-center">
                  <div class="card-body">
                    <img src="assets/images/
											<?php echo get_result($conn, $id, 'user')['image']; ?>" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="name" name="name" placeholder="Enter name" value="<?= get_result($conn, $id, 'user')['name']; ?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="mb-3">
                              <label for="useremail" class="form-label">Email Address</label>
                              <input type="email" class="form-control" id="useremail" readonly value="<?= $_SESSION['login_users']['email']; ?>">
                            </div>
                          </div>
                        </div>
                        <!-- end row -->
                        <div class="row">
                          <div class="col-md-6">
                            <div class="mb-3">
                              ...
                              <input type="password" class="form-control" id="password" name="password" placeholder="Enter password" value="<?= $_SESSION['login_users']['password']; ?>">
                            </div>
                          </div>
                          <!-- end col -->
                          <div class="col-md-6">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="phone" name="phone" placeholder="" value="<?= get_result($conn, $id, 'user')['phone']; ?>">
                            </div>
                          </div>
                          <!-- end col -->
                          <div class="col-md-6">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="percentage" name="percentage" placeholder="" value="<?= get_result($conn, $id, 'user')['percentage']; ?>">
                            </div>
                          </div>
                          <!-- end col -->
                          <div class="col-md-6">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="delivery_fee" name="delivery_fee" placeholder="" value="<?= get_result($conn, $id, 'user')['delivery_fee']; ?>">
                            </div>
                          </div>
                          <!-- end col -->
                        </div>
