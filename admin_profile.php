                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="userpassword" class="form-label">Percentage</label>
                                                             <input type="text" class="form-control" id="percentage" name="percentage" placeholder="" value="<?php echo get_result($conn,$_SESSION['login_users']['id'], 'user')['percentage']; ?>">
                                                        </div>
                                                    </div> <!-- end col -->
                                                     ...
                                                     <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="userpassword" class="form-label">Delivery Fee</label>
                                                             <input type="text" class="form-control" id="delivery_fee" name="delivery_fee" placeholder="" value="<?php echo get_result($conn,$_SESSION['login_users']['id'], 'user')['delivery_fee']; ?>">
                                                        </div>
                                                    </div> <!-- end col -->
