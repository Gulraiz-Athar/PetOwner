...
<div class="app-menu">  
    ...
    <div class="scrollbar">
        ...
        <div class="user-box text-center">
            ...
            <div class="dropdown">
                <a href="javascript: void(0);" class="dropdown-toggle h5 mb-1 d-block" data-bs-toggle="dropdown">okok</a>
        ...
        <?php if($_SESSION['login_users']['role'] == "admin"){ ?>
        ...
        <ul class="menu">
            ...
            <li class="menu-item">
                <a href="deliveries.php" class="menu-link">
            ...
            <li class="menu-item">
                <a href="payouts.php" class="menu-link">
        ...
        <ul class="menu">
            ...
            <li class="menu-title">Menu</li>
            <li class="menu-item">
                <a href="prescription_invoice_vet.php" class="menu-link">
                    <span class="menu-icon"><i class="mdi mdi-account-multiple-outline"></i></span>
                    <span class="menu-text"> Prescription History </span>
                </a>
            </li>

            <li class="menu-item">
                <a href="pet_owners_available.php" class="menu-link">
                    <span class="menu-icon"><i class="mdi mdi-clipboard-multiple-outline"></i></span>
                    <span class="menu-text"> Pet Owners Available </span>
                </a>
            </li>
        ...
        <?php }else if($_SESSION['login_users']['role'] == "petowner"){ ?>
            ...
            <ul class="menu">
                ...
                <li class="menu-title">Menu</li>
                <li class="menu-item">
                    <a href="pet_profile.php" class="menu-link">
                        <span class="menu-icon"><i class="mdi mdi-account-multiple-outline"></i></span>
                        <span class="menu-text"> Profile </span>
                    </a>
                </li>
                ...
                <li class="menu-item">
                    <a href="prescription_invoice_pet.php" class="menu-link">
                        <span class="menu-icon"><i class="mdi mdi-clipboard-multiple-outline"></i></span>
                        <span class="menu-text"> Prescription History</span>
                    </a>
                </li>
                ...
                <li class="menu-item">
                    <a href="vet_invoices.php" class="menu-link">
                        <span class="menu-icon"><i class="mdi mdi-clipboard-multiple-outline"></i></span>
                        <span class="menu-text"> Invoices   </span>
                    </a>
                </li>
