...
class ThemeCustomizer {
    ...
    setSwitchFromConfig() {
        ...
        sessionStorage.setItem('__Televet_MATERIAL_CONFIG__', JSON.stringify(this.config));
        // localStorage.setItem('__Televet_MATERIAL_CONFIG__', JSON.stringify(this.config));
