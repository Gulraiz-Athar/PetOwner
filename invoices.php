                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="" class="table activate-select dt-responsive nowrap w-100">
                      ...
                      <tbody> <?php $invoices = mysqli_query($conn, "SELECT * FROM `invoices` ORDER BY id DESC");
                        ...
                        ?> <tr>
                          ...
                          <td> <?php
                                if($invoice['status'] == '1'){?> <span class="badge bg-soft-success text-success">Paid</span> <?php }else if($invoice['status'] == '2'){?> <span class="badge bg-soft-info text-info">New</span> <?php }else if($invoice['status'] == '3'){?> <span class="badge bg-soft-danger text-danger">Pending</span> <?php }else if($invoice['status'] == '4'){?> <span class="badge bg-soft-warning text-warning">Delivered</span> <?php }
                                ?>
                          </td>
                          <td> <?php
                                 if($invoice['status'] == '1'){?> <span class="badge bg-soft-success text-success">Paid</span> <?php }else if($invoice['status'] == '2'){?> <span class="badge bg-soft-info text-info">New</span> <?php }else if($invoice['status'] == '3'){?> <span class="badge bg-soft-danger text-danger">Pending</span> <?php }else if($invoice['status'] == '4'){?> <span class="badge bg-soft-warning text-warning">Delivered</span> <?php }
                          ...
                          <td>
                            <a class="btn btn-xs btn-danger delete-btn-invoice" data_id="<?= $invoice['id'] ?>">
