                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="widget-chart text-center" dir="ltr">
                                            <input data-plugin="knob" data-width="120" data-height="120" data-linecap=round data-bgColor="rgba(0,0,0,0.1)" data-fgColor="#5DADBF" value="37" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".12"/>
                                            <h5 class="text-muted mt-3">Total sales made today</h5>
                                            <h2>29</h2>
