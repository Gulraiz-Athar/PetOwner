                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table activate-select dt-responsive nowrap w-100">
                                            ...
                                            <?php
                                                        ...
                                                        $pet_id = $_SESSION['login_users']['id'];
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                        ...
                                                                        if($invoice['status'] == '2'){?>
                                                                            ...
                                                                            <a href="stripe/index.php?id=<?php echo  $invoice['stripe_invoice_id'] ?>&pet_id=<?php echo $_SESSION['login_users']['id']; ?>" class=" btn btn-success">Pay</a>
