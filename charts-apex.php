                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase1" class="collapse show" dir="ltr">
                                            <div class="row pt-3">
                                                <div class="col-md-4">
                                                    <div id="spark1" class="apex-charts mb-sm-0 mb-4" data-colors="#5DADBF"></div>
                                                </div>
                                                <div class="col-md-4">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase2" class="collapse show" dir="ltr">
                                            <div id="apex-line-1" class="apex-charts pt-3" data-colors="#5DADBF,#1abc9c"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase4" class="collapse show" dir="ltr">
                                            <div id="apex-area" class="apex-charts pt-3" data-colors="#5DADBF,#f7b84b,#CED4DC"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase5" class="collapse show" dir="ltr">
                                            <div id="apex-column-1" class="apex-charts pt-3" data-colors="#5DADBF,#1abc9c,#CED4DC"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase6" class="collapse show" dir="ltr">
                                            <div id="apex-column-2" class="apex-charts pt-3" data-colors="#5DADBF"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase7" class="collapse show" dir="ltr">
                                            <div id="apex-mixed-1" class="apex-charts pt-3" data-colors="#CED4DC,#5DADBF"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase9" class="collapse show" dir="ltr">
                                            <div id="apex-bar-2" class="apex-charts pt-3" data-colors="#5DADBF,#1abc9c"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase10" class="collapse show" dir="ltr">
                                            <div id="apex-mixed-2" class="apex-charts pt-3" data-colors="#5DADBF,#1abc9c,#f672a7"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase11" class="collapse show" dir="ltr">
                                            <div id="apex-mixed-3" class="apex-charts pt-3" data-colors="#5DADBF,#ebf2f6,#f672a7"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase12" class="collapse show" dir="ltr">
                                            <div id="apex-bubble-1" class="apex-charts pt-3" data-colors="#5DADBF,#1abc9c,#f672a7"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase13" class="collapse show" dir="ltr">
                                            <div id="apex-bubble-2" class="apex-charts pt-3" data-colors="#5DADBF,#1abc9c,#f672a7,#6c757d"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase15" class="collapse show" dir="ltr">
                                            <div id="apex-scatter-2" class="apex-charts pt-3" data-colors="#1abc9c,#f672a7,#6c757d,#5DADBF,#6559cc"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase16" class="collapse show" dir="ltr">
                                            <div id="apex-candlestick-1" class="apex-charts pt-3" data-colors="#5DADBF,#1abc9c"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase17" class="collapse show" dir="ltr">
                                            <div class="pt-3">
                                                <div id="apex-candlestick-2" class="apex-charts" data-colors="#5DADBF,#f7b84b"></div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase18" class="collapse show" dir="ltr">
                                            <div id="apex-pie-1" class="apex-charts pt-3" data-colors="#5DADBF,#4fc6e1,#4a81d4,#00b19d,#f1556c"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase19" class="collapse show" dir="ltr">
                                            <div id="apex-pie-2" class="apex-charts pt-3" data-colors="#5DADBF,#4fc6e1,#4a81d4,#00b19d,#f1556c"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase20" class="collapse show" dir="ltr">
                                            <div id="apex-pie-3" class="apex-charts pt-3" data-colors="#5DADBF,#4fc6e1,#4a81d4,#00b19d,#f1556c"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="cardCollpase22" class="collapse show" dir="ltr">
                                            <div id="apex-radialbar-2" class="apex-charts pt-3" data-colors="#5DADBF,#e36498,#23b397,#f7b84b"></div>
                                        </div> <!-- collapsed end -->
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col-->
