            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Apps";$title = "File Manager";
                                                        ...
                                                        <div class="card m-1 shadow-none border">
                                                            <div class="p-2">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col">
                                                                        <a href="javascript:void(0);" class="text-muted fw-bold">Televet Integrations</a>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <span class="ms-2 fw-semibold"><a href="javascript: void(0);" class="text-reset">Televet-sketch-design.zip</a></span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">Feb 13, 2020</p>
                                                                    <span class="font-12">by&nbsp; Spiderhunts</span>
                                                                </td>
                                                                <td>521 MB</td>
                                                                <td>
                                                                    Coder Themes
