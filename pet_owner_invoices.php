                      ...
                      <tbody> <?php $pet_id = $_GET['id'];
                          ...
                          <td>
                            <h5 class="m-0 fw-normal">
                              <a href="invoice_detail.php?id=
																	<?php echo  $invoice['id'] ?>"> <?= $invoice['id'] ?> </a>
                            </h5>
                          </td>
                          <td>
                          ...
                          <td> <?php if($invoice['status'] == '1'){?> <a href="#" invoice_id=<?php echo $invoice['id']; ?> class="badge bg-soft-success text-success">Pending </a> <?php }else if($invoice['status'] == '2'){?> <span class="badge bg-soft-info text-info">New</span> <?php }else if($invoice['status'] == '3'){?> <a href="https://api.wyngit.com/api/v1/orders/
																<?php echo $invoice['wyngit_id'] ?>/label?api_key=210511497528261495a6869d06439dc93d9220da5b129572e68f1ad1f3fbf8dc" class="badge bg-soft-danger text-danger">Paid </a> <?php }else if($invoice['status'] == '4'){?> <span class="badge bg-soft-warning text-warning">Delivered</span> <?php }
                           ?> </td>
                          <td>
                            <div class="dropdown float-end">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="assets/php/invoice_pdf.php?id=
																		<?= $invoice['id'] ?>" class="dropdown-item" role="button">
