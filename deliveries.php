                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="" class="table activate-select dt-responsive nowrap w-100">
                      ...
                      <tbody> <?php $invoices = mysqli_query($conn, "SELECT * FROM `transactions` ORDER by id DESC");
                        ...
                        <tr>
                          ...
                          <td> <?php  $user_id = $invoice['user_id']; ?>
