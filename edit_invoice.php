                    ...
                    <div class="row">
                          ...
                          <select name="petowner_id" id="petowner_id" class="form-control">
                            <option value="">Select Pet Owner</option> <?php
                                ...
                                while ($petowner = mysqli_fetch_assoc($petowners)) {
                                    ?> <option value="
                                        <?= $petowner['id'] ?>" <?= ($petowner['id'] == $invoice['pet_owner_id']) ? "selected" : "" ?>> <?= $petowner['name'] ?> </option> <?php
                                }
                                ?>
                          </select>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input class="form-control" type="text" placeholder="" name="units" required value="<?php echo $row_invoice_data['units']; ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input class="form-control" type="text" placeholder="" name="cost" value="<?php echo $row_invoice_data['paid_to_vet']; ?>" required>
                        </div>
                      </div>
                    </div>
