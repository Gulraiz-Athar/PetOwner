...
<head>
    <?php
    $title = "Auth Pages | Create Account | Sign In";
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="p-3">
                        ...
                        <ul class="nav nav-tabs nav-bordered">
                            <li class="nav-item">
                                <a href="#tab-login" data-bs-target="#tab-login" data-bs-toggle="tab" aria-expanded="false" class="nav-link active">
                                    Log In
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#tab-signup" data-bs-target="#tab-signup" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                                    Sign Up
                                </a>
                            </li>
                        </ul>
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted">2015 - <script>document.write(new Date().getFullYear())</script> &copy; Televet  <a href="javascript: void(0);" class="text-muted">Spiderhunts</a> </p>
                        </footer>
