                                ...
                                <div class="card-body">
                                    ...
                                    <table id="" class="table activate-select dt-responsive nowrap w-100">
                                            ...
                                            <?php
                                                        ...
                                                        $invoices = mysqli_query($conn, "SELECT * FROM `invoices` WHERE `status` = '2' ORDER by id DESC");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        $user_id = $invoice['pet_owner_id']; 
                                                                    
                                                                    ?>
                                                                    
                                                                    <h5 class="m-0 fw-normal"><?php echo get_result($conn,$user_id,'user')['name']; ?> </h5>
                                                                    <p class="mb-0 text-muted"><small><a href="#"><?php echo get_result($conn,$user_id,'user')['email']; ?></a></small></p>
                                                                </td>
