            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Projects";$title = "Project Details";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-2">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="w-100">
                                                    <h5 class="mt-0"><a href="contacts-profile.php" class="text-reset">Jeremy Tomlinson</a> <small class="text-muted">3 hours ago</small></h5>
                                                    ...
                                                    <div class="d-flex align-items-start mt-3">
                                                        ...
                                                        <div class="w-100">
                                                            <h5 class="mt-0"><a href="contacts-profile.php" class="text-reset">Kathleen Thomas</a> <small class="text-muted">1 hours ago</small></h5>
                                            ...
                                            <div class="d-flex align-items-start mt-3">
                                                <img class="me-2 avatar-sm rounded-circle" src="assets/images/users/user-2.jpg"
                                                    alt="Generic placeholder image">
                                                <div class="w-100">
                                                    <h5 class="mt-0"><a href="contacts-profile.php" class="text-reset">Jonathan Tiner</a> <small class="text-muted">1 day ago</small></h5>
                                        ...
                                        <div class="card mb-1 shadow-none border">
                                            <div class="p-2">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col ps-0">
                                                        <a href="javascript:void(0);" class="text-muted fw-bold">Televet-sketch-design.zip</a>
