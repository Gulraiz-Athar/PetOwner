                            ...
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <div class="text-start mt-3">
                                        ...
                                        <p class="text-muted mb-1 font-13"><strong>Location :</strong> <span class="ms-2"><?php echo get_result_users($conn,$_SESSION['login_users']['id'], 'user')['city']; ?></span></p>
                                    </div>
                                    <br>
                                        ...
                                        <div class="tab-pane show active" id="settings">
                                            <form action="assets/php/update_vet_profile.php" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="useremail" readonly value="<?php echo $_SESSION['login_users']['email']; ?>">
                                                 ...
                                                 <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="useremail" class="form-label">Pharmacy Name</label>
                                                            <input type="text" class="form-control" id="ph_name" name="ph_name" placeholder="" value="<?php echo get_result_users($conn,$_SESSION['login_users']['id'])['pharmacy_name']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="userpassword" class="form-label">Pharmacy Code</label>
                                                            <input type="text" class="form-control" id="ph_code" name="ph_code" placeholder="" value="<?php echo get_result_users($conn,$_SESSION['login_users']['id'])['pharmacy_code']; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="useremail" class="form-label">Pharmacy Address</label>
                                                            <input type="text" class="form-control" id="ph_address" name="ph_address" placeholder="" value="<?php echo get_result_users($conn,$_SESSION['login_users']['id'])['pharmacy_address']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
