...
<head>
    ...
    include("assets/php/function.php");
     ...
     $user_role = mysqli_query($conn, "SELECT * FROM `user` WHERE `id` = '$pet_id'");
     $row_user = mysqli_fetch_assoc($user_role);
     $role = $row_user['role'];
                                    ...
                                    <table id="" class="table activate-select dt-responsive nowrap w-100">
                                            ...
                                            <?php
                                                         if($role == "petowner"){
                                                             ...
                                                             $invoices_pet = mysqli_query($conn, "SELECT * FROM `invoices` WHERE `pet_owner_id` = '$pet_id'  ORDER by `id` DESC");
                                                             
                                                         }else{
                                                             
                                                             $invoices_pet = mysqli_query($conn, "SELECT * FROM `invoices` WHERE `veterinarian_id` = '$pet_id'  ORDER by `id` DESC");
