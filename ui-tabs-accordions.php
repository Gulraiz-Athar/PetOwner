            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Base UI";$title = "Tabs & Accordions";
                                ...
                                <div class="accordion custom-accordion" id="custom-accordion-one">
                                    ...
                                    <div class="card mb-0">
                                        ...
                                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix"
                                            data-bs-parent="#custom-accordion-one">
                                            <div class="card-body">
                                                Use our dedicated support email (support@Spiderhunts.com) to
                                    ...
                                    <div class="card mb-0">
                                        <div class="card-header" id="headingSeven">
                                            <h5 class="m-0 position-relative">
                                                <a class="custom-accordion-title text-reset collapsed d-block"
                                                    ...
                                                    Q. Will you regularly give updates of Televet ? <i
                                                        class="mdi mdi-chevron-down accordion-arrow"></i>
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="collapseSeven" class="collapse"
                                            ...
                                            data-bs-parent="#custom-accordion-one">
                                            <div class="card-body">
                                                Yes, We will update the Televet regularly. All the
